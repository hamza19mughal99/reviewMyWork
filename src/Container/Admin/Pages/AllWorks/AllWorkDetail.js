...
const AllWorkDetail = () => {
    ...
    useEffect(() => {
        dispatch(ArtistGetWork(getId))
    }, [])

    useEffect(() => {
        if (artistGetWorkData) {
            setWorkDetail(artistGetWorkData?.data?.find((d) => d._id === id))
        }
    }, [artistGetWorkData])
        ...
        <div>
            {
                loading ? <div style={{ height: "100vh", display: "flex", justifyContent: "center", alignItems: "center" }}>
                    ...
                    <Container className='mt-5'>
                        ...
                        <div className='reviewed_data mx-5' ref={componentRef}>
                            {

...
import { EditAboutGet } from '../../../Redux/Action/EditPages'
      ...
      <Container>
        {
          loading ? <PleaseWaitLoader /> :
            <div className='main_description_wrapper' dangerouslySetInnerHTML={{__html: getAboutEditData?.data[0]?.aboutText}}>

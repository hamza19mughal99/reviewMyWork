...
import { EditTestimonialGet } from '../../../Redux/Action/EditPages';
            ...
            <Container>
                {
                    loading ? <PleaseWaitLoader /> :
                        <div className='main_description_wrapper' dangerouslySetInnerHTML={{ __html: getTestimonialEditData?.data[0]?.testimonialText }}>
